...
> **Version:** 1.1.0 | **Target Standard:** WCAG 2.2 AAA (Shield) | **Last Updated:** 2026-07-20
...
| :------------------- | :------- | :----------------------------- | :-------- | :------------------------------------ | :------------------------------- |
| **🛡️ Shield (AAA)**  | WCAG AAA | 7:1 / 3:1 (SC 1.4.6, 1.4.11)   | 14px†     | 44×44px (SC 2.5.5) · 48×48px† advised | **Active for this project**      |
| **⚖️ Standard (AA)** | WCAG AA  | 4.5:1 / 3:1 (SC 1.4.3, 1.4.11) | 12px†     | 24×24px (SC 2.5.8) · 44×44px† advised | Production apps, public web      |
...
- 🟠 **HIGH:** **Perception and Readability** failures. Significantly increases **Error or Abandonment Rate** (e.g., Insufficient contrast, Fonts < 14px in critical text, Lack of Dynamic Feedback). **MUST FIX.**
...
- **Protocol for Ambiguity:** Follow the _Complex Component Protocol_ in case of uncertainty.
...
_References: [Images](references/guide-images.md) | [Content & Timing](references/guide-content-interaction.md) | [Visual Perception & Color](references/guide-visual-perception.md) | [Responsive & Zoom](references/guide-responsive-mobile.md)_

- **Contrast (SC 1.4.6, 1.4.11 — Shield):** Text **MUST** have 7:1; UI components and meaningful graphics **MUST** have 3:1. Prioritize real **luminance difference** (light vs dark) beyond hue.
...
- **Targets (SC 2.5.5 — Shield):** Interactive elements **MUST** be at least **44×44 CSS pixels** (48×48 advised). Expand hit area via padding when visual size is smaller.
...
_References: [Forms & Errors](references/guide-forms.md) | [Content & Microcopy](references/guide-content-interaction.md) | [Tables](references/guide-tables.md) | [Toasts & Notifications](references/guide-toasts-notifications.md) | [Loading & Skeletons](references/guide-loading-skeleton.md) | [Tooltips & Popovers](references/guide-tooltips-popovers.md)_
...
- **Typography (House Rule†):** Text **MUST NOT** be smaller than **14px** (Shield profile).
  - _Density Exception:_ In badges or secondary metadata, **min 12px** allowed only with **7:1** contrast and documented in `EXCEPTIONS.md`.

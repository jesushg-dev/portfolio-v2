...
export function ConsoleForm({ initial }: ConsoleFormProps) {
  ...
  const initialConsoleCode = typeof initial?.consoleCode === "string"
    ? initial.consoleCode
  ...
  const handleSubmit = useCallback(
    (values: FormValues) => {
      startTransition(async () => {
        setServerError(null);
        try {
          const defaultText = typeof initial?.default === "string" ? initial.default : "";
          const translationsText = typeof initial?.translations === "object" && initial?.translations !== null

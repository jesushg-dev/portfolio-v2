...
type CertificationRow = RouterOutputs["portfolioAdmin"]["getMyCertifications"][number];
...
export const CertificationsList: FC<CertificationsListProps> = ({
  ...
  const deleteCertification = api.portfolioAdmin.deleteCertification.useMutation();
  ...
  const { table } = useDataTable({
    ...
    initialState: {
      sorting: [{ id: "title" as Extract<keyof CertificationRow, string>, desc: false }],
    },
    shallow: true,
  });

...
import { ExternalLink, Copy, Check, Music2 } from "lucide-react";
  ...
  return (
    <aside className="bg-card text-card-foreground flex flex-col gap-4 rounded-xl border p-5">
      <div className="flex items-center gap-2">
        <div className="flex size-7 items-center justify-center rounded-lg bg-[#1DB954]/15 text-[#1DB954]">
      ...
      <div className="border-border/60 mt-1 border-t pt-3">
        ...
        >
          <span className="inline-flex items-center gap-1.5 font-medium">
            <Music2 className="size-3.5 text-[#1DB954]" aria-hidden />

...
import { ExternalLink, HardDrive, KeyRound } from "lucide-react";
import { buttonVariants } from "@/components/ui/button";

export function UploadThingIntegrationGuide() {
    ...
    <aside className="bg-card text-card-foreground flex flex-col gap-4 rounded-xl border p-5">
      ...
      <ol className="text-muted-foreground space-y-3 text-xs leading-relaxed">
        <li className="flex items-start gap-2.5">
          ...
          <span>{t("guides.uploadthing.step1")}</span>
        </li>
        <li className="flex items-start gap-2.5">
          <span className="bg-muted text-foreground flex size-5 shrink-0 items-center justify-center rounded-full font-mono text-[0.6875rem] font-semibold">
            2
          </span>
          <span>{t("guides.uploadthing.step2")}</span>
        </li>
        <li className="flex items-start gap-2.5">
          <span className="bg-muted text-foreground flex size-5 shrink-0 items-center justify-center rounded-full font-mono text-[0.6875rem] font-semibold">
            3
          </span>
          <span>{t("guides.uploadthing.step3")}</span>
        </li>
        <li className="flex items-start gap-2.5">
          <span className="bg-muted text-foreground flex size-5 shrink-0 items-center justify-center rounded-full font-mono text-[0.6875rem] font-semibold">
            4
          </span>
          <span>{t("guides.uploadthing.step4")}</span>
        </li>
      </ol>
      ...
      <div className="border-border/60 mt-1 border-t pt-3">
        ...
        >
          <span className="inline-flex items-center gap-1.5 font-medium">
            ...
            {t("guides.uploadthing.dashboardLink")}
          </span>

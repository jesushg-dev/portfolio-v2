          ...
          {!alwaysVisible && (
            <div
              ...
              <ul className="mt-4 flex flex-col rounded-lg px-4 md:mt-0 md:flex-row md:space-x-4 md:border-0 md:text-sm md:font-medium ">
                <NavButton title={t('menu.home')} onClick={() => handleScroll('home')} />
                <NavButton title={t('menu.about')} onClick={() => handleScroll('about')} />
                <NavButton title={t('menu.skills')} onClick={() => handleScroll('skills')} />
                <NavButton title={t('menu.portfolio')} onClick={() => handleScroll('portfolio')} />
                <NavButton title={t('menu.contact')} onClick={() => handleScroll('contact')} />
              </ul>
            </div>
          )}
        </div>

...
import { type ComponentProps, createContext, useCallback, useContext, useMemo, useState, type ReactNode } from "react";
...
const FacetedContext = createContext<FacetedContextValue<boolean> | null>(
  null,
);

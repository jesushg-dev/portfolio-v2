        ...
        <div className="space-y-1">
          <div className="relative border-background-300">
            ...
            <input
              ...
              {...inputProps}
              ref={inputRef as any}
              className={`w-full rounded border ${borderColorClasses[error]} bg-transparent px-3 py-3 text-sm text-primaryText-500 placeholder-divider-200 shadow-sm focus:border-primary-700 focus:outline-none  ${inputProps?.className}`}
            />
          </div>
          <div

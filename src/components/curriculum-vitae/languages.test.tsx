...
import { mockLanguage, mockAppLanguages, mockCvPreviewData } from "@/test-utils/fixtures/cv-data";
import { renderWithIntl } from "@/test-utils/render-with-intl";
import { mapCvDataToLocalized } from "./types";

function getLocalizedLang(lang: typeof mockLanguage, locale: "en" | "es" = "en") {
...
describe("Languages", () => {
  ...
  it("renders localized language name and level", () => {
    renderWithIntl(<Languages languages={[getLocalizedLang(mockLanguage, "es")]} />);

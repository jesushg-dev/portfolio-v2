...
import { HiOutlineUserGroup, HiOutlineDesktopComputer, HiOutlineDatabase } from 'react-icons/hi';
  ...
  return (
    <div className="flex w-full items-center justify-center">
      <Tab
        ...
        />
        <TabItem icon={HiOutlineDatabase} title={t('tabs.backend.title')} description={t('tabs.backend.description')} />
        <TabItem icon={HiOutlineUserGroup} title={t('tabs.tools.title')} description={t('tabs.tools.description')} />
      </Tab>
    </div>
  );
};

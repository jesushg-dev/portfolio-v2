...
const SoftSkills: FC<ISoftSkillsProps> = ({}) => {
  ...
  return (
    <section className="hero relative flex h-[50vh] w-full flex-col items-center  overflow-hidden bg-black before:bg-hero-skills md:h-[65vh]">
      ...
      <div className="absolute inset-0 z-20 flex h-full w-full scroll-pl-16 items-center gap-6 overflow-x-auto overflow-y-hidden pt-10 text-secondaryText-50 lg:snap-x lg:snap-mandatory">

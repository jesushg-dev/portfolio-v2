...
describe("LyricsFullscreen", () => {
  const defaultProps = {
    ...
    syncedLyrics: "[00:10.00] Like the legend of the phoenix\n[00:20.00] All ends with beginnings",
    accentColor: "#1db954",
    showProgress: true,
    progressMs: 15000,
    durationMs: 240000,
  ...
  it("renders song title, artist, synced lyrics, and back button", () => {
    ...
    expect(screen.getByText("Like the legend of the phoenix")).toBeInTheDocument();
  ...
  it("renders plain lyrics when syncedLyrics is null", () => {
    render(<LyricsFullscreen {...defaultProps} syncedLyrics={null} showProgress={false} />);

...
describe("ProgressBar", () => {
  it("renders readOnly progressbar element", () => {
    renderWithIntl(<ProgressBar value={50} readOnly ariaLabel="Playback progress" />);
  ...
  it("renders interactive range input when readOnly is false", () => {
    ...
    renderWithIntl(
      <ProgressBar value={30} readOnly={false} onChange={onChange} ariaLabel="Interactive progress" />
    );

...
describe("LyricsCard component", () => {
  ...
  it("renders empty state when status is empty or error", () => {
    ...
    expect(screen.getByText("Lyrics unavailable for this track")).toBeInTheDocument();
  });
  ...
  it("renders synced lyrics and calls onExpand when clicked", () => {
    ...
    render(
      <LyricsCard
        ...
        lyricsState={{
          status: "ready",
          lyrics: { plainLyrics: "Line one\nLine two", syncedLyrics: syncedLrc },
        }}
        progressMs={2000}
        labels={labels}
        onExpand={onExpand}
  ...
  it("renders plain lyrics when syncedLyrics is null", () => {
    render(
      <LyricsCard
        ...
        lyricsState={{
          status: "ready",
          lyrics: { plainLyrics: "Plain verse line 1\nPlain verse line 2", syncedLyrics: null },
        }}
        progressMs={0}
        labels={labels}
        onExpand={jest.fn()}

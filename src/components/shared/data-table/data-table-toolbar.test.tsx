...
function makeMockColumn(id: string, variant?: string, extraMeta?: Record<string, unknown>) {
...
describe("DataTableToolbar", () => {
  it("renders text filter input and handles change", () => {
    const colText = makeMockColumn("name", "text", { placeholder: "Search name" });
  ...
  it("renders range, date, and select filter components", () => {
    const cols = [
      ...
      makeMockColumn("category", "select", { options: [{ label: "A", value: "a" }] }),
    ];

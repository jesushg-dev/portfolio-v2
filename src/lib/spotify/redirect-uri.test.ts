const mockEnv = {
  ...
  SPOTIFY_REDIRECT_URI: undefined as string | undefined,
};
...
describe("getSpotifyRedirectUri", () => {
  beforeEach(() => {
    ...
    mockEnv.SPOTIFY_REDIRECT_URI = undefined;
  });
  ...
  it("respects SPOTIFY_REDIRECT_URI override", () => {
    mockEnv.SPOTIFY_REDIRECT_URI = "http://127.0.0.1:4000/api/spotify/callback";

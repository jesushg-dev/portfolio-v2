import { translationMapToLocalizedFields, localizedFieldsToTranslationMap } from "./localized-persist";
...
describe("translationMapToLocalizedFields", () => {
  it("converts a translation map to localized title and description fields", () => {
    ...
    const result = translationMapToLocalizedFields(translations, languages, "en");
...
describe("localizedFieldsToTranslationMap", () => {
  it("builds a TranslationMap from localized fields", () => {
    ...
    const result = localizedFieldsToTranslationMap(title, description, languages);
  ...
  it("handles plain string localized fields", () => {
    const result = localizedFieldsToTranslationMap("My Title", "My Desc", languages);
  ...
  it("produces empty string when language code is completely absent from the map", () => {
    ...
    const result = localizedFieldsToTranslationMap(title, description, allLanguages);
